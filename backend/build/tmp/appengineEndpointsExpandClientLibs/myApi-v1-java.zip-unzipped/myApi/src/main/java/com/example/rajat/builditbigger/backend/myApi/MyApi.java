 ...
 * on 2016-10-30 at 09:10:29 UTC 
 * Modify at your own risk.
 */

package com.example.rajat.builditbigger.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "passJoke".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link PassJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public PassJoke passJoke() throws java.io.IOException {
    PassJoke result = new PassJoke();
    initialize(result);
    return result;
  }

  public class PassJoke extends MyApiRequest<com.example.rajat.builditbigger.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "passJoke";

    /**
     * Create a request for the method "passJoke".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link PassJoke#execute()} method to invoke the remote operation. <p>
     * {@link
     * PassJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected PassJoke() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.rajat.builditbigger.backend.myApi.model.MyBean.class);
    }

    @Override
    public PassJoke setAlt(java.lang.String alt) {
      return (PassJoke) super.setAlt(alt);
    }

    @Override
    public PassJoke setFields(java.lang.String fields) {
      return (PassJoke) super.setFields(fields);
    }

    @Override
    public PassJoke setKey(java.lang.String key) {
      return (PassJoke) super.setKey(key);
    }

    @Override
    public PassJoke setOauthToken(java.lang.String oauthToken) {
      return (PassJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public PassJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (PassJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public PassJoke setQuotaUser(java.lang.String quotaUser) {
      return (PassJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public PassJoke setUserIp(java.lang.String userIp) {
      return (PassJoke) super.setUserIp(userIp);
    }

    @Override
    public PassJoke set(String parameterName, Object value) {
      return (PassJoke) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.rajat.builditbigger.backend.myApi.model.MyBean> {
